...
EVENT_HUB_NAME = spark.conf.get("EVENT_HUB_SUPPLIER_PERFORMANCE_NAME")
EVENT_HUB_CONSUMER_GROUP = spark.conf.get("EVENT_HUB_SUPPLIER_PERFORMANCE_CONSUMER_GROUP")
